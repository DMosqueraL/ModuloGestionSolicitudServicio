...
public class SolicitudPaqueteController {
    ...
    @ApiResponse(responseCode = "200", description = "Listado de Solicitudes de Paquete")
    ...
    @Operation(summary = "- Endpoint para obtener una solicitud de paquete en SSMU por su id")
    ...
    @Operation(summary = "- Endpoint para buscar una solicitud de paquete en SSMU por fecha")
    @ApiResponse(responseCode = "200", description = "Solicitud de paquete por fecha obtenida con éxito")
    ...
    @Operation(summary = "- Endpoint para eliminar una solicitud de paquete en SSMU")
    @ApiResponse(responseCode = "200", description = "Solicitud de paquete eliminada con éxito")
    ...
    @Operation(summary = "- Endpoint para actualizar una solicitud de paquete en SSMU")
    @ApiResponse(responseCode = "200", description = "Solicitud de paquete actualizada con éxito")
